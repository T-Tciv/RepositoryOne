...
public class Main {
    public static void main(String[] args) {
        ...
        vector.setComponent(0, -3);
        vector.setComponent(1, 1);
        vector.setComponent(2, 2);
