...
public class Main {
    public static void main(String[] args) {
        ...
        if (range.isInside(userNumber)) {
            System.out.printf("Число %f принадлежит диапазону от %f до %f.", userNumber, range.getFrom(), range.getTo());
        } else {
            System.out.printf("Число %f не принадлежит диапазону от %f до %f.", userNumber, range.getFrom(), range.getTo());
        }
    }
}
